...
df = yf.download("aapu", start="2023-01-01", end="2023-12-31", progress=False) # QQQ 3배
...
class Rsi4SplitStrategy(bt.Strategy):
    params = dict(rsi_period=4, rsi_buy1=50, rsi_buy2=25, rsi_sell=80)
    ...
    def next(self):
        ...
        if self.rsi[0] < self.p.rsi_buy1 and not self.buy1:
            ...
            self.buy1 = True
            return  # 하루에 하나만 실행되도록 명시적 return
